...
public class SymmetricMatrixGenTest {
    ...
    private static String TEST_OUTPUT = "/home/arian/IdeaProjects/MyProject/input";

    @Test
    public void testGraphGenerator() throws Exception {
        PrintWriter printWriter = new PrintWriter("/home/arian/IdeaProjects/MyProject/graph.txt", "UTF-8");

        Configuration conf = new Configuration();

        SymmetricMatrixGen.main(new String[] { "3", "10", TEST_OUTPUT, "1" });
